...
public class RollerIONeo550 implements RollerIO {
    ...
    public RollerIONeo550(int runExternalID, int runInternalID) {
        ...
        externalRoller.configure(externalConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
        ...
        internalRoller.configure(internalConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
    ...
    public void updateInputs(RollerIOInputs inputs, MotorIOInputs external, MotorIOInputs internal) {
        ...
        inputs.externalPosition = UnitUtil.reduceAngle(Units.Rotations.of(externalRoller.getEncoder().getPosition()));
        inputs.internalPosition = UnitUtil.reduceAngle(Units.Rotations.of(internalRoller.getEncoder().getPosition()));
    }
}
